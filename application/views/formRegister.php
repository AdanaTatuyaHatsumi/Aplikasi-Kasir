              ...
              <?php echo $this->session->flashdata('pesan') ?>
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter your username password & repassword</p>
                  </div>

                  <form class="row g-3 needs-validation" method="POST" action="<?php echo base_url('welcome') ?>" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="rememberMe">Tampil Password</label>
                      </div>
                    </div>
                    <div class="col-12">
                      <button class="btn btn-primary w-100 mb-2" type="submit">Register</button>
                      <a href="<?php echo base_url('welcome') ?>" class="btn btn-primary w-100" type="submit">Login</a>
                    </div>
                  </form>
